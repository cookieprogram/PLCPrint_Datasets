I've added some datasets for 2 different PLC models (Siemens and AB (Allen-Bradley)). There are some baseline files which contain normal behaviour and then files with attacks. The datasets that contain no
